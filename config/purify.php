    ...
    */
    ...
    'configs' => [
        ...
        'default' => [
            ...
            'HTML.Allowed' => 'h1,h2,h3,h4,h5,h6,b,u,strong,i,em,s,del,a[href|title|target|rel],ul,ol,li,p[style],br,span[style|class],img[width|height|alt|src],blockquote,pre[class],code[class],table,thead,tbody,tfoot,tr,th[style],td[style],figure,figcaption,hr,sup,sub,mark',
            'HTML.ForbiddenElements' => 'script,style,iframe,form,input,textarea,select,button,object,embed',
            'CSS.AllowedProperties' => 'font,font-size,font-weight,font-style,font-family,text-decoration,padding-left,color,background-color,text-align,width,height,border',
