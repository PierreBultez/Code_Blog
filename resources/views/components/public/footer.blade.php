<footer class="flex flex-col md:flex-row justify-between items-center px-8 py-12 max-w-5xl mx-auto mt-20 border-t border-zinc-200 dark:border-zinc-800 bg-transparent text-sm uppercase tracking-widest">
